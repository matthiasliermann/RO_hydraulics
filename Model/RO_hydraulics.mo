package RO_hydraulics "package for modeling reverse osmosis membrane process"
  model RO_system "Example system for RO process"
    ...
    OpenHydraulics.Basic.VarPressureSource source annotation (
      Placement(visible = true, transformation(origin = {-58, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Cosine cosine1(amplitude = 35e5, freqHz = 2, offset = 36e5) annotation (
      Placement(visible = true, transformation(origin = {-118, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    OpenHydraulics.Basic.VarVolumeSource source2 annotation (
      Placement(visible = true, transformation(origin = {-22, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Sources.Cosine cosine2(amplitude = 0e-5, freqHz = 2, offset = -20e-5) annotation (
      Placement(visible = true, transformation(origin = {-68, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(cosine2.y, source2.control) annotation (
      Line(points = {{-57, -28}, {-32, -28}, {-32, -28}, {-32, -28}}, color = {0, 0, 127}));
    connect(cosine1.y, source.control) annotation (
      Line(points = {{-107, 8}, {-68, 8}, {-68, 8}, {-68, 8}}, color = {0, 0, 127}));
    connect(source2.port, rO1.port_fout) annotation (
      Line(points = {{-22, -18}, {-22, 8.2}}, color = {255, 0, 0}));
    connect(source.port, rO1.port_fin) annotation (
      Line(points = {{-58, 18}, {-32, 18}}, color = {255, 0, 0}));
  end RO_system;
  ...
  model RO "Series of segments of one RO module modeled as one element"
    ...
    RO_middle rO_middle1(dx = 0.88 / 5) annotation (
      Placement(visible = true, transformation(origin = {-40, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    RO_middle rO_middle2(dx = 0.88 / 5) annotation (
      Placement(visible = true, transformation(origin = {0, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    RO_middle rO_middle3(dx = 0.88 / 5) annotation (
    ...
    OpenHydraulics.Interfaces.FluidPort port_fout "feed outlet port (reject)" annotation (
      Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -98}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    RO_middle rO_first(dx = 0.88 / 5) annotation (
    ...
    RO_middle rO_last(dx = 0.88 / 5) annotation (
      Placement(visible = true, transformation(origin = {74, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(rO_middle2.port_pout, rO_middle3.port_pin) annotation (
      Line(points = {{9.8, 10}, {18, 10}, {18, 28}, {38, 28}, {38, 20}}, color = {0, 0, 255}));
    connect(rO_middle2.port_fout, rO_middle3.port_fin) annotation (
      Line(points = {{0, 0}, {0, -10}, {22, -10}, {22, 10}, {28, 10}}, color = {0, 0, 255}));
    connect(rO_middle1.port_pout, rO_middle2.port_pin) annotation (
      Line(points = {{-30.2, 10}, {-20, 10}, {-20, 28}, {0, 28}, {0, 20}}, color = {0, 0, 255}));
    connect(rO_middle1.port_fout, rO_middle2.port_fin) annotation (
      Line(points = {{-40, 0}, {-40, -10}, {-16, -10}, {-16, 10}, {-10, 10}}, color = {0, 0, 255}));
    ...
    connect(rO_first.port_pout, rO_middle1.port_pin) annotation (
      Line(points = {{-64.2, 10}, {-58, 10}, {-58, 28}, {-40, 28}, {-40, 20}}, color = {0, 0, 255}));
    connect(rO_middle1.port_fin, rO_first.port_fout) annotation (
      Line(points = {{-50, 10}, {-54, 10}, {-54, -10}, {-74, -10}, {-74, 0}}, color = {0, 0, 255}));
    connect(rO_middle3.port_fout, rO_last.port_fin) annotation (
      Line(points = {{38, 0}, {38, -10}, {58, -10}, {58, 10}, {64, 10}}, color = {0, 0, 255}));
    connect(rO_middle3.port_pout, rO_last.port_pin) annotation (
      Line(points = {{47.8, 10}, {52, 10}, {52, 30}, {74, 30}, {74, 20}}, color = {0, 0, 255}));
    annotation (
  ...
  model RO_first "First element for modeling of membrane"
    ...
    Port_f pin_n4 annotation (
      Placement(visible = true, transformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Port_f pin_n5 annotation (
      Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    ...
    annotation (
      ...
      Icon(graphics={  Polygon(points = {{-100, 100}, {100, 100}, {100, -100}, {-100, 100}}, lineColor = {0, 0, 255},
              lineThickness =                                                                                                         0.5, fillColor = {0, 0, 255},
              fillPattern =                                                                                                                                                       FillPattern.Solid), Text(extent = {{-38, 86}, {108, 2}}, lineColor = {255, 255, 255},
              lineThickness =                                                                                                                                                                                                        0.5, fillColor = {0, 0, 255},
  ...
  model RO_last "Last element for modeling of membrane"
    ...
    Port_f pin_n annotation (
      Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Port_f pin_n1 annotation (
...
<dd>by Christoph Clauss initially implemented
  ...
  partial model PartialTwoPort
    Port_a port_a annotation (
      Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Port_b port_b annotation (
      Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  ...
  model TestModel
    RO_hydraulics.Source_p_c source_p_c1(c=400)
                                         annotation (
  ...
  model TestConductor
    extends RO_hydraulics.PartialTwoPort;
