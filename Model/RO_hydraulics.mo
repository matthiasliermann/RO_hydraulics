package RO_hydraulics "package for modeling reverse osmosis membrane process"
  ...
  model TestModel
    RO_hydraulics.Sources.Source_p_c source_p_c1(c=400) annotation (Placement(
          visible=true, transformation(
          origin={-100,0},
          extent={{-10,-10},{10,10}},
          rotation=0)));
    Sources.Source_m_flow source_m_flow1(m_flow=-1/60) annotation (Placement(
          visible=true, transformation(
          origin={100,0},
          extent={{-10,-10},{10,10}},
          rotation=0)));
  ...
  model RO_module
    ...
    Interfaces.Port_b permeate annotation (Placement(transformation(extent={{90,
              -8},{110,12}}), iconTransformation(extent={{90,-8},{110,12}})));
    Interfaces.Port_a feed annotation (Placement(transformation(extent={{-112,-10},
              {-92,10}}), iconTransformation(extent={{-112,-10},{-92,10}})));
    Interfaces.Port_b reject annotation (Placement(transformation(extent={{-12,
              -110},{8,-90}}), iconTransformation(extent={{-12,-110},{8,-90}})));
    Sources.Source_m_flow source_m_flow(m_flow=0, c=0)
  ...
  model TestRO_module
    ...
    RO_hydraulics.Sources.Source_p_c source_reject_p(c=600, p=5000000)
    ...
    RO_middle_stream rO_middle_stream1
      annotation (Placement(transformation(extent={{-36,-10},{-16,10}})));
    RO_middle_stream rO_middle_stream2
      annotation (Placement(transformation(extent={{0,-10},{20,10}})));
    RO_middle_stream rO_middle_stream3
      annotation (Placement(transformation(extent={{30,-10},{50,10}})));
    RO_middle_stream rO_middle_stream4
      annotation (Placement(transformation(extent={{60,-10},{80,10}})));
    Sources.Source_m_flow_signal source_m_flow_signal
  ...
  equation
    ...
    connect(rO_middle_stream.port_feed_b, rO_middle_stream1.port_feed_a)
      annotation (Line(points={{-60,-10},{-62,-10},{-62,-24},{-36,-24},{-36,0}},
          color={0,0,255}));
    connect(rO_middle_stream.port_permeate_b, rO_middle_stream1.port_permeate_a)
      annotation (Line(points={{-50,0},{-42,0},{-42,16},{-26,16},{-26,10}}, color=
           {0,0,255}));
    connect(rO_middle_stream.port_permeate_a, source_permeate_flow.port_a)
      annotation (Line(points={{-60,10},{-60,36},{-14,36},{-14,68}}, color={0,0,255}));
    connect(rO_middle_stream1.port_feed_b, rO_middle_stream2.port_feed_a)
      annotation (Line(points={{-26,-10},{-24,-10},{-24,-20},{-2,-20},{-2,-6},{0,-6},
            {0,0}}, color={0,0,255}));
    connect(rO_middle_stream1.port_permeate_b, rO_middle_stream2.port_permeate_a)
      annotation (Line(points={{-16,0},{-6,0},{-6,18},{10,18},{10,10}}, color={0,0,
            255}));
    connect(rO_middle_stream2.port_feed_b, rO_middle_stream3.port_feed_a)
      annotation (Line(points={{10,-10},{10,-22},{30,-22},{30,0}}, color={0,0,255}));
    connect(rO_middle_stream2.port_permeate_b, rO_middle_stream3.port_permeate_a)
      annotation (Line(points={{20,0},{24,0},{24,16},{40,16},{40,10}}, color={0,0,
            255}));
    connect(rO_middle_stream3.port_feed_b, rO_middle_stream4.port_feed_a)
      annotation (Line(points={{40,-10},{40,-22},{56,-22},{56,0},{60,0}}, color={0,
            0,255}));
    connect(rO_middle_stream3.port_permeate_b, rO_middle_stream4.port_permeate_a)
      annotation (Line(points={{50,0},{52,0},{52,20},{70,20},{70,10}}, color={0,0,
            255}));
    connect(rO_middle_stream4.port_feed_b, source_reject_p.port_b) annotation (
        Line(points={{70,-10},{70,-26},{30,-26},{30,-82},{-2,-82}}, color={0,0,255}));
    connect(rO_middle_stream4.port_permeate_b, source_permeate_p.port_b)
      annotation (Line(points={{80,0},{90,0}}, color={0,0,255}));
    connect(source_m_flow_signal.port_a, rO_middle_stream.port_feed_a)
      annotation (Line(points={{-82,0},{-70,0}}, color={0,0,255}));
    connect(ramp.y, source_m_flow_signal.u)
      annotation (Line(points={{-109,0},{-101.6,0}}, color={0,0,127}));
  end TestRO_module;
...
<dd>by Christoph Clauss initially implemented
    ...
    partial model PartialTwoPort
      Interfaces.Port_a port_a annotation (Placement(
          visible=true,
          transformation(
            origin={-100,0},
            extent={{-10,-10},{10,10}},
          ...
          iconTransformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=0)));
      Interfaces.Port_b port_b annotation (Placement(
          visible=true,
          transformation(
            origin={100,0},
            extent={{-10,-10},{10,10}},
  ...
  This will be visualized at the port icons, in order to improve the understanding of fluid model diagrams.
    ...
    partial model PartialFourPort
      Interfaces.Port_a port_feed_a annotation (Placement(
          visible=true,
          transformation(
            origin={-100,0},
            extent={{-10,-10},{10,10}},
          ...
          iconTransformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=0)));
      Interfaces.Port_b port_feed_b annotation (Placement(
          visible=true,
          transformation(
            origin={0,-100},
            extent={{-10,-10},{10,10}},
    ...
    protected
      parameter Boolean showDesignFlowDirection = true "= false to hide the arrow in the model icon";
    public
      Interfaces.Port_a port_permeate_a annotation (Placement(
          visible=true,
          transformation(
            origin={0,100},
            extent={{-10,-10},{10,10}},
          ...
          iconTransformation(
            ...
            extent={{-10,-10},{10,10}},
            rotation=0)));
      Interfaces.Port_b port_permeate_b annotation (Placement(
          visible=true,
          transformation(
            origin={100,0},
            extent={{-10,-10},{10,10}},
  ...
  package Sources
    ...
    model Source_m_flow_signal
      ...
      Modelica.Blocks.Interfaces.RealInput u annotation (Placement(transformation(
            extent={{20,-20},{-20,20}},
            rotation=0,
            origin={106,0}), iconTransformation(extent={{116,-20},{76,20}})));
    equation
      port_a.m_flow = - u;
      port_a.c = if m_flow > 0 then c else inStream(port_a.c);
      annotation (
